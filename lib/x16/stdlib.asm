...
; XC=BASIC
;
; Standard library for Commander X16
; Author: Csaba Fekete alias Neils
; (except where stated otherwise)
; ---------------------------------------------------------

; X16 I/O registers
X16_VIA1_PB			EQU $9f60
X16_VIA1_PA			EQU $9f61
...
KERNAL_BASIN		EQU $ffcf
KERNAL_BSOUT		EQU $ffd2
KERNAL_GETIN 		EQU $ffe4	
KERNAL_SCREEN_SET_MODE EQU $ff5f                                         
...
STDLIB_MEMSETUP SUBROUTINE
	; Bank KERNAL into the ROM
	basicout
	; Reset RAM bank
	lda #$00
	sta X16_VIA1_PA
	; Default screen is 80x60 text
	; Todo - make it changeable with a PRAGMA
	lda #80
	sta STDLIB_SCREEN_COLS
	lda #60
	sta STDLIB_SCREEN_ROWS
	lda #$02
	jsr KERNAL_SCREEN_SET_MODE
	rts
